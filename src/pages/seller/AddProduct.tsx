...
const AddProduct = () => {
    ...
    const [thumbnails, setThumbnails] = useState<File | null>(null)
            ...
            >
                ...
                <div className="p-8 flex flex-col gap-6 max-w-4xl">
                    ...
                    <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
                        ...
                        >
                            {thumbnails ? (
                                <img src={URL.createObjectURL(thumbnails)} alt="Thumbnail" className="w-full h-100  object-cover rounded-lg" />
                            ) : (
                                <>
                    ...
                    <div className="flex items-center justify-end gap-3 pb-8">
                        ...
                        <button className="px-6 py-2.5 rounded-lg bg-primary text-white text-sm font-medium hover:bg-primary-hover transition-colors" onClick={handleAddProduct}>
                            Save Product
                        </button>
                    </div>
