...
const CategoryCart = ({ icon, title }: {
    ...
    const Icon = icon
    return (
        <Link to={`/category?catItem=${title}`} className="h-40 w-50 shadow-sm rounded-xl flex flex-col items-center justify-center p-4 group hover:shadow-md  transition-all duration-200">
