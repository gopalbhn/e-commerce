...
import { createOrder, getMyOrder, getOrder, getPendingOrders, getPurchasedProduct, getSellerOrder, updateOrderStatus } from "../controllers/orderController.js";

const router = Router();

router.get('/', authenticateUser, getMyOrder)
router.get('/history', authenticateUser, getPurchasedProduct);
